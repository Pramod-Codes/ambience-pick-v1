    ...
    <Shell noPadBottom>
      ...
      <div className="flex flex-1 flex-col px-5 pb-7 pt-5">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mt-5 font-heading text-lg font-semibold">Booking Confirmed!</h1>
          <p className="mt-1 text-sm text-muted-foreground">Your table has been successfully reserved.</p>
        </div>
        ...
        <button onClick={() => navigate("/home")} className="mt-7 w-full rounded-full bg-primary py-4 text-base font-semibold text-primary-foreground shadow-soft transition-transform active:scale-[0.98]">Back To Home</button>
      </div>
    </Shell>
  );
}
